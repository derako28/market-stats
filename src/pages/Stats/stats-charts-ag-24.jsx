...
const columns = [
  ...
  { id: "ib_breakout", title: "IB Breakout", type: FILTER_TYPES.SELECT },
      ...
      <div className={"mt-8 pb-20"}>
        <div className={"flex justify-center gap-16 mb-20"}>
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getChartConfig(tableData, "open", OPENS_LABEL, 600, 600)}
            />
          </div>
          <div className={"flex flex-col justify-center items-center"}>
        ...
        <div className={"flex justify-center gap-16 mb-20"}>
          ...
          <div className={"flex flex-col justify-center items-center"}>
            <div className={"text-gray-300 mb-10"}>
              IB Extension (NY Continuation London)
            </div>
            <AgCharts
              options={getChartConfigForExt(
                tableData,
        ...
        <div className={"flex justify-center gap-16 mb-10"}>
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartConfig(
                getDataIBChart(dataWithIbInfo(tableData), IB_BREAKOUT_LABELS),
                tableData.length,
                700,
                300,
              )}
          ...
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartConfig(
                getDataIBChart(
                  dataWithIbInfo(tableData, "ib_breakout_ny"),
                  IB_BREAKOUT_LABELS,
                ),
                tableData.length,
                700,
        ...
        <div className={"flex justify-center gap-16"}>
          <div className={"flex flex-col justify-center items-center"}>
            <div className={"text-gray-300"}>2h IB Breakout </div>
            <AgCharts
              options={getBarChartConfig(
                getDataIBChart(
                  dataWithIbInfo(tableData, "ib_breakout_2h"),
                  IB_BREAKOUT_LABELS,
                ),
                tableData.length,
                700,
          ...
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartHorizontalConfig(
                getDataIBSizeChart(newData2023, "ib_size"),
                1700,
                300,
              )}
            />
        ...
        <div className={"flex justify-center gap-16 mt-20 mb-10"}>
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartHorizontalConfig(
                getDataIBSizeChart(newData2023, "ib_size_segmented"),
                1700,
                300,
              )}
            />
        ...
        <div className={"flex justify-center gap-16 mb-10"}>
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartHorizontalConfig(
                getDataIBSizeChart(tableData, "ib_ext"),
                1700,
                300,
              )}
            />
        ...
        <div className={"flex justify-center gap-16 mb-20"}>
          <div className={"flex flex-col justify-center items-center"}>
            ...
            <AgCharts
              options={getBarChartHorizontalConfig(
                getDataIBSizeChart(tableData, "ib_ext_ny"),
                1700,
                300,
              )}
            />
