...
const excludeFilterOptions = [
  ...
  // { id: 'ib_breakout', title: 'IB Breakout', type: FILTER_TYPES.SELECT, options: getOptions(IB_BREAKOUT)  },
  {
    ...
    title: "Direction",
    type: FILTER_TYPES.SELECT,
    options: getOptions(DIRECTION_OPTIONS),
  },
  {
    id: "result",
    title: "Result",
...
const initialData = segmentData(
  mergeStatsAndBack(sortByDate(dataStats), sortByDate(dataBacktest)),
);

const optimizedData = segmentData(
  mergeStatsAndBack(sortByDate(dataStats), sortByDate(dataBacktest)),
);

export const BacktestsTapok = () => {
  const [tableData, setTableData] = useState(optimizedData || []);
  ...
  return (
    <Page>
      <div>
        ...
        <div
          className={
            "text-gray-300 flex align-middle items-start my-5 px-4 gap-3"
          }
        >
        ...
        <div className={"flex flex-col items-center"}>
          ...
          <AgCharts
            options={optionsForLineChart(
              connectTwoData(initialData, tableData),
              getDataLine,
              1500,
              500,
            )}
          ...
          <div className={"text-white flex flex-col gap-2"}>
            ...
            {/*<Statistic data={removeDuplicateDirectionsPerDay(initialData)} />*/}

            {/*<div className={"mt-4 mb-4"}>Optimized Data</div>*/}
            {/*<Statistic data={tableData} />*/}

            {/*<Statistic data={removeFourthWeek(optimizedData)} />*/}
      ...
      <div className={"flex justify-center gap-16 mt-10 mb-5 px-20"}>
        <div className={"flex flex-col items-center"}>
          ...
          <AgCharts
            options={getChartConfigForBacktest(tableData, getWinRate, 500, 500)}
          />
        </div>
      ...
      <div className={"flex justify-center gap-16 mb-20"}>
        <div className={"flex flex-col justify-center items-center"}>
          ...
          <AgCharts
            options={getChartConfig(tableData, "open", OPENS_LABEL, 500, 500)}
          />
        </div>
        <div className={"flex flex-col justify-center items-center"}>
