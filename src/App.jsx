      ...
      <Router>
          <div>
              <Routes>
                  ...
                  <Route path="/market-stats/stats-table-new" element={<StatsTableNew />} />
                  <Route path="/market-stats/stats-charts" element={<StatsChartsAg />} />
                  <Route path="/market-stats/stats-charts-2024" element={<StatsChartsAG2024 />} />
                  <Route path="/market-stats/stats-charts-es" element={<StatsChartsAGFiniteqES />} />
                  <Route path="/market-stats/stats-charts-nq" element={<StatsChartsAGFiniteqNQ />} />
                  <Route path="/market-stats/backtests" element={<Backtests />} />
                  <Route path="/market-stats/backtests-sanya" element={<BacktestsSanya />} />
                  <Route path="/market-stats/backtests-tapok" element={<BacktestsTapok />} />
                  <Route path="/market-stats/backtests-tapok-US500" element={<BacktestsTapokUS500 />} />
              </Routes>
          </div>
      </Router>
  )
